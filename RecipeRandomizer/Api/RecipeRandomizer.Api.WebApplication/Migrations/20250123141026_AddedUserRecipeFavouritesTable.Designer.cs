...
namespace RecipeRandomizer.Api.WebApplication.Migrations
{
    ...
    [Migration("20250123141026_AddedUserRecipeFavouritesTable")]
    partial class AddedUserRecipeFavouritesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecipeRandomizer.Api.Data.Entities.UserRecipeFavourite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RecipeRandomizer.Api.Data.Entities.UserRecipeRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RecipeRandomizer.Api.Data.Entities.UserRecipePreference", b =>
                {
                    b.HasOne("RecipeRandomizer.Api.Data.Entities.RecipePreference", "RecipePreference")
                        .WithMany()
                        .HasForeignKey("RecipePreferenceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RecipePreference");
                });
